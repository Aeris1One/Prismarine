...
### Usable URLs ###
  ...
  - **API** - http://localhost:7976/test
  - **DB Interface** - http://localhost:7976/dbshell
  - **Java Class Browser** - http://localhost:7976/doc
...
### Testing ###
  ...
  - all API calls can be tested manually from the auto-generated http://localhost:7976/test page
